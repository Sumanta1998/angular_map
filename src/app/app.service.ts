...
export class DemoService {
  ...
  private clientId: string =
    "33OkryzDZsL5CXiNgriplBNsaMU2FjeBHNZm7-Y7Xz2pWFeN9NEmLvvlyRkcjNZAyATLGaXD1eQtyyyiIsjYbw==";
  private clientSecret: string =
    "lrFxI-iSEg-kB6lGpmpR61QpqilX46ID7ob4RXuwD94TM0lSTlZInO7JaVKf1xZvyknmJLM5uUCPAtdzeTqQdbrraX3HfoMB";
  private securityURL: string =
    "https://outpost.mapmyindia.com/api/security/oauth/token?grant_type=" +
    this.grantType +
    "&client_id=" +
    this.clientId +
    "&client_secret=" +
